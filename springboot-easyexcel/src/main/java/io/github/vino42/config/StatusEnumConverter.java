...
//        Type genericType = contentProperty.getField().getGenericType();
        ...
        StatusEnum code = StatusEnum.getInstance(stringValue);
        return code;
     ...
     */
    @Override
    public WriteCellData<?> convertToExcelData(StatusEnum value, ExcelContentProperty contentProperty, GlobalConfiguration globalConfiguration) throws Exception {
