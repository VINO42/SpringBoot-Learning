...
public class UserMeetingWebSocketEndPoint implements EndPoint {
    ...
    public static ConcurrentHashMap<String, Session> ONLINE_USER_SESSIONS = new ConcurrentHashMap<>();
    ...
    public void onOpen(Session session, @PathParam(value = "userId") String userId) throws IOException {
        ...
        RedisTemplate stringRedisTemplate = SpringUtil.getBean("redisTemplate");
        stringRedisTemplate.opsForHash().put("userId", userId, HashUtil.fnvHash(userId));
    ...
    public void onClose(@PathParam("userId") String userId, Session session) {
        ...
        RedisTemplate stringRedisTemplate = SpringUtil.getBean("redisTemplate");
        stringRedisTemplate.opsForHash().delete("userId", userId, HashUtil.fnvHash(userId));
